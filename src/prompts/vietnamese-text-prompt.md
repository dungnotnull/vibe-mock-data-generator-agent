...
Yêu cầu: 2-3 câu, tự nhiên như trên sàn thương mại điện tử, không dùng markdown, không bắt đầu bằng "Đây là".

## Customer Review
Viết một đánh giá khách hàng tiếng Việt ({rating}/5 sao) cho sản phẩm "{productName}".
